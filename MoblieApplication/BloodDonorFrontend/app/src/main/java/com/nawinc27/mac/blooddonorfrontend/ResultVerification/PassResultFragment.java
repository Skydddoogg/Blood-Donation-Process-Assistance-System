...
public class PassResultFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        userId = getView().findViewById(R.id.pass_userId);
        hospitalId = getView().findViewById(R.id.pass_hospitalId);
        session = new SessionManager(getContext());
        button = getView().findViewById(R.id.pass_button);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_pass_verified , container , false);
    }
